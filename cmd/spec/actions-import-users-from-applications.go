...
func init() {
	...
	Specification.Resources = append(Specification.Resources, &Resource{
		ID:   "actions/import-users-from-applications",
		Name: "Import users from applications",
		...
		Endpoints: []*Endpoint{
			{
				Name:        "Create action",
				Description: "Create a source action to import users from an application API.",
				Method:      POST,
				URL:         "/v1/actions",
			...
			{
				Name:        "Update action",
				Description: "Update a source action that imports users from an application API.",
				Method:      PUT,
				URL:         "/v1/actions/:id",
				Parameters: []types.Property{
					{
			...
			{
				Name:        "Get action",
				Description: "Get a source action that imports users from an application API.",
				Method:      GET,
				URL:         "/v1/actions/:id",
				Parameters: []types.Property{
					{
				...
				Response: &Response{
					Parameters: []types.Property{
						...
						},
						{
							...
							Prefilled:   `"API"`,
							Description: "The type of the connection's connector. It is always `\"API\"` when the action imports users from an application API.",
						},
						{
							Name:        "connection",
							Type:        types.Int(32),
						...
						},
						{
							...
							Prefilled:   `"Source"`,
							Description: "The role of the action's connection. It is always `\"Source\"` when the action imports users from an application API.",
						},
						{
							Name:        "target",
							Type:        types.Text().WithValues("User", "Event"),
							Prefilled:   `"User"`,
							Description: "The entity on which the action operates. It is always `\"User\"` when the action imports users from an application API.",
						},
						{
							Name:        "enabled",
							Type:        types.Boolean(),
