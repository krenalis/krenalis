...
func init() {
	...
	filterParameter := types.Property{
		...
		Description: "The filter applied to the API users. If it's not null, only the API users that match the filter will be included, otherwise all users will be included.\n\n" +
		...
		Type: types.Object([]types.Property{
			{
				...
				UpdateRequired: true,
				Nullable:       true,
				Description:    "The transformation mapping. A key represents a property path in the user schema, and its corresponding value is an expression. This expression can reference property paths from the source schema of the API.",
			},
			{
				Name: "function",
				Type: types.Object([]types.Property{
				...
				UpdateRequired: true,
				Nullable:       true,
				Description:    "The transformation function. A JavaScript or Python function that given an API user, returns a user identity.",
			},
		}),
		Prefilled:      `...`,
		CreateRequired: true,
		UpdateRequired: true,
		Description: "The mapping or function responsible for transforming API users into user identities linked to the action. " +
	...
	inSchemaParameter := types.Property{
		...
		Description: "The schema for the properties used in the filter, as well as the input properties for the transformation.\n\n" +
			"When importing users from apps, this should be a subset of the API's destination schema.",
	}
	...
	Specification.Resources = append(Specification.Resources, &Resource{
		ID:   "actions/import-users-from-apis",
		Name: "Import users from APIs",
		Description: "This type of action imports user data from an API into the workspace's data warehouse. " +
			"It operates on a source API connection that supports users.",
		Endpoints: []*Endpoint{
			{
				Name:        "Create action",
				Description: "Create a source action to import users from an API.",
				Method:      POST,
				URL:         "/v1/actions",
				Parameters: []types.Property{
					nameParameter,
					{
						...
						CreateRequired: true,
						Prefilled:      "230527183",
						Description:    "The ID of the connection from which to read the users. It must be a source API that can import users.",
					},
					{
						Name:           "target",
			...
			{
				Name:        "Update action",
				Description: "Update a source action that imports users from an API.",
				Method:      PUT,
				URL:         "/v1/actions/:id",
				Parameters: []types.Property{
					{
						...
						CreateRequired: true,
						Prefilled:      "705981339",
						Description:    "The ID of the source API action to update.",
					},
					nameParameter,
					{
						Name:        "enabled",
			...
			{
				Name:        "Get action",
				Description: "Get a source action that imports users from an API.",
				Method:      GET,
				URL:         "/v1/actions/:id",
				Parameters: []types.Property{
					{
						...
						CreateRequired: true,
						Prefilled:      "705981339",
						Description:    "The ID of the source API action that imports users.",
					},
				},
				Response: &Response{
					Parameters: []types.Property{
						...
						},
						{
							...
							Prefilled:   `"API"`,
							Description: "The type of the connection's connector. It is always `\"API\"` when the action imports users from an API.",
						},
						{
							Name:        "connection",
							Type:        types.Int(32),
							Prefilled:   "1371036433",
							Description: "The ID of the connection from which users are read. It is a source API that supports users.",
						},
						{
							Name:        "connectionRole",
							Type:        types.Text().WithValues("Source", "Destination"),
							Prefilled:   `"Source"`,
							Description: "The role of the action's connection. It is always `\"Source\"` when the action imports users from an API.",
						},
						{
							Name:        "target",
							Type:        types.Text().WithValues("User", "Event"),
							Prefilled:   `"User"`,
							Description: "The entity on which the action operates. It is always `\"User\"` when the action imports users from an API.",
						},
						{
							Name:        "enabled",
							Type:        types.Boolean(),
