		...
		Type: types.Object([]types.Property{
			{
				...
				CreateRequired: true,
				Prefilled:      `"email"`,
				Description:    "The matching input property. It cannot be empty.\n\nIt represents the path of the property in the user schema. Its definition must also be included in the action's input schema.",
			},
			{
				Name:           "out",
				Type:           types.Text(),
			...
			},
			{
				...
				Type: types.Object([]types.Property{
					...
					},
					{
						...
						Prefilled:      `[ "email", "first_name", "last_name" ]`,
						CreateRequired: true,
					...
					},
					{
						Name:           "outPaths",
						Type:           types.Array(types.Text()),
						Prefilled:      `[ "emailAddress", "firstName", "lastName" ]`,
						CreateRequired: true,
