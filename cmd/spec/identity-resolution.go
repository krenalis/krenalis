...
func init() {
	...
	Specification.Resources = append(Specification.Resources, &Resource{
		...
		Description: "Identities are the users obtained from sources like [apps](api/connections/apps), [databases](api/connections/databases), [files](api/connections/file-storages), or events. " +
