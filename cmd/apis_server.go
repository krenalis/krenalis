...
func newAPIsServer(apis *apis.APIs, sessionKey []byte) *apisServer {
	...
	paths := map[string]func(w http.ResponseWriter, r *http.Request) (any, error){
		...
		"DELETE /api/workspaces/{workspace}/connections/{connection}/events/connections/{connection2}":   connection.RemoveEventConnection,
		...
		"DELETE /api/workspaces/{workspace}/warehouse":                                                   workspace.DisconnectWarehouse,
		...
		"GET    /api/workspaces/{workspace}/action-stats/dates":                                          workspace.ActionStatsPerDate,
		"GET    /api/workspaces/{workspace}/action-stats/days":                                           workspace.ActionStatsPerDay,
		"GET    /api/workspaces/{workspace}/action-stats/hours":                                          workspace.ActionStatsPerHour,
		"GET    /api/workspaces/{workspace}/action-stats/minutes":                                        workspace.ActionStatsPerMinute,
		...
		"GET    /api/workspaces/{workspace}/identity-resolution/execution":                               workspace.IdentityResolutionExecution,
		...
		"POST   /api/workspaces/{workspace}/identity-resolutions":                                        workspace.RunIdentityResolution,
