...
func newAPIsServer(core *core.Core, sessionKey []byte, runsOnHTTPS bool) *apisServer {
	...
	paths := map[string]func(w http.ResponseWriter, r *http.Request) (any, error){
		/* only UI */ "DELETE /api/members/{member}":                                                   organization.DeleteMember,
		...
		/* only UI */ "GET    /api/members": organization.Members,
		/* only UI */ "GET    /api/members/current": api.Member,
		/* only UI */ "GET    /api/members/invitations/{token}":                                          api.MemberInvitation,
		...
		/* done (*) */ "GET    /api/workspaces/{workspace}/connections/{connection}/executions": connection.Executions,
		...
		/* only UI */ "GET    /api/workspaces/{workspace}/connections/{connection}/ui": connection.ServeUI,
		"GET    /api/workspaces/{workspace}/event-listeners/{listener}/events":         workspace.ListenedEvents,
		/* done (*) */ "GET    /api/workspaces/{workspace}/identifiers-schema": workspace.IdentifiersSchema,
		...
		/* only UI */ "POST   /api/expressions-properties": api.ExpressionsProperties,
		/* only UI */ "POST   /api/members/invitations": organization.InviteMember,
		/* only UI */ "POST   /api/members/login": s.login,
		/* only UI */ "POST   /api/members/logout": s.logout,
		/* only UI */ "POST   /api/transformations": api.TransformData,
		/* only UI */ "POST   /api/validate-expression":                                           api.ValidateExpression,
		...
		/* only UI */ "POST   /api/workspaces/{workspace}/connections/{connection}/actions/{action}/ui-event": action.ServeUI,
		...
		/* only UI */ "POST   /api/workspaces/{workspace}/connections/{connection}/ui-event": connection.ServeUI,
		...
		/* only UI */ "POST   /api/workspaces/{workspace}/ui": workspace.ServeUI,
		/* only UI */ "POST   /api/workspaces/{workspace}/ui-event":        workspace.ServeUI,
		...
		/* only UI */ "PUT    /api/members/current": organization.SetMember,
		/* only UI */ "PUT    /api/members/invitations/{token}":                                        api.AcceptInvitation,
