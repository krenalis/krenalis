...
func endpoints(s *apisServer) map[string]endpointHandler {
	...
	return map[string]endpointHandler{
		...
		"DELETE /organizations/{id}":                          organization.Delete,          /* Need platform management API key */
		...
		"GET    /organizations/{id}":                          api.Organization,                     /* Need platform management API key */
		"GET    /organizations":                               api.Organizations,                    /* Need platform management API key */
		...
		"POST   /organizations":                               api.CreateOrganization,       /* Need platform management API key */
		...
		"PUT    /organizations/{id}":                          organization.Update,             /* Need platform management API key */
		"PUT    /organizations/{id}/status":                   organization.SetStatus,          /* Need platform management API key */
