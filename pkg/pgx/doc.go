...
chichi/pkg/pgx/stdlib to use pgx as a database/sql compatible driver. See that package's documentation for
details.
...
chichi/pkg/pgx/pgxpool for a concurrency safe connection pool.
...
For debug tracing of the actual PostgreSQL wire protocol messages see chichi/pkg/pgx/pgproto3.

Lower Level PostgreSQL Functionality

chichi/pkg/pgx/pgconn contains a lower level PostgreSQL driver roughly at the level of libpq. pgx.Conn in
