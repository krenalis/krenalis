...
11. Under **connectors > Mailchimp**, enter the client ID and client secret you copied earlier in the **oauthClientID** and **oauthClientSecret** fields, respectively.
...
4. Next to the **Mailchimp** source, click the **+** icon. The source addition page will open.
5. Optional: In the **Name** field, enter a name for the source to easily recognize it later.
6. In the **List** field, select the Mailchimp list from which to read the contacts. You can change it later.
7. Click **Add**.
