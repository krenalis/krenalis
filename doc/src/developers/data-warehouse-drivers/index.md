...
| `users_identities` | `__connection__`                        | `Int(32)`     | not null                                                      | Connection from which the identity is imported                                                                                           |
| `users_identities` | `__identity_id__`                       | `Text`        | not null                                                      | Identifier for the identity. For anonymous identities, this is the anonymous ID.                                                         |
| `users_identities` | `__is_anonymous__`                      | `Boolean`     | not null, default false                                       | True for anonymous identities, false in any other case.                                                                                  |
