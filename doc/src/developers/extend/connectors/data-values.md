...
| `uuid`[^2] [^5] [^uuid_nil]                                             | ◦`string`<br/>◦`[]byte`                                                                                                                                                                                                                                                   | `"0296345b-23f6-48b4-9547-ff83fb637d0e"`<br/>`[]byte{211, 124, 89, 213, 136, 127, 68, 248, 143, 250, 126, 36, 49, 79, 71, 62}`                                                                                                                                                                                                                                                                                                                                                              |
...
| `inet`[^2]                                                              | ◦`string`<br/>◦[`net.IP`](https://pkg.go.dev/net#IP)<br/>◦[`netip.Addr`](https://pkg.go.dev/netip#Addr)                                                                                                                                                                   | `"192.168.1.1"`<br/>`net.ParseIP("192.168.1.1")`<br/>`netip.MustParseAddr("192.168.1.1")` → `"192.168.1.1"`                                                                                                                                                                                                                                                                                                                                                                                 |
...
[^uuid_nil]: `[]byte(nil)` values are interpreted as `nil` for *nullable* `uuid` types.
