...
A connection enables Chichi to retrieve customer and event data from an external source location or send them to an external destination location.
...
To connect Chichi to an external location, add a connection. Choose a **source connection** if you want to retrieve data or events, or a **destination connection** if you want to send data or events.
...
A source connection enables you to retrieve customer and event data from an external location, then transform and consolidate it within your data warehouse. Chichi allows you to add multiple sources from which to receive data and events.
