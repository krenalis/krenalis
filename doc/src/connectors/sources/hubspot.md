...
> HubSpot does not support authentication via IP addresses. When using "127.0.0.1" as the Meergo domain, replace it with "localhost" when adding a HubSpot data source.
