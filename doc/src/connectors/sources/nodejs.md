...
- [Using the SDK](#using-the-sdk)
  - [1. Add source connection for Node.js](#1-add-source-connection-for-nodejs)
...
4. Click on the connection for **Node.js** connector. A panel will open on the right with information about **Node.js**.
