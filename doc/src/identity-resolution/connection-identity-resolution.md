...
for users **imported from files** and **databases**, the user is merged with other users within the same connection who share the same value for the unique ID column specified in the action's editing page;
