...
To make an anonymize call, you can use a Chichi SDK. Refer to its documentation for more details. For example, with the JavaScript SDK in the browser, you can make an anonymize call in the following way:
```javascript
