...
* a **workspace-specific configuration**, which can be easily modified at any time via the GUI by the Meergo Admin console. This is the most dynamic form of configuration, which sets things like the *data warehouse*, *connections*, *actions*, *transformations*, *identity resolution*, etc.
