...
> This section applies if you configure Meergo via the .env file. **If you run Meergo with docker**, or **if you pass environment variables directly to the Meergo process**, you can **skip this section and refer to the variables documentation below**.
