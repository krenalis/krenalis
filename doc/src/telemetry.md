...
This behavior can be disabled by setting the environment variable `MEERGO_DISABLE_TELEMETRY` to `"true"`. For more details, see the [configuration](configuration) section.
