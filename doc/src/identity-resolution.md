...
An identifier is **a property path** which refers to a property of the `users_identities` schema which have a *compatible type* (see the issue [#321](https://github.com/open2b/chichi/issues/321)).
...
The anonymous identifiers, like non-anonymous ones, refer to the properties of the `users_identities` schema properties and **have lower priority** than the former.
