...
> Before adding a CSV data destination, ensure that you have configured a storage data destination such as HTTP, S3, or SFTP. If you haven’t set up a storage destination yet, please do so before proceeding with the CSV file export.
