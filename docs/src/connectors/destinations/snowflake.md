...
4. Click on the connection for **Snowflake**. A panel will open on the right.
5. Click on **Add destination...**. The `Add destination connection for Snowflake` page will appear.
