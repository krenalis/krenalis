...
To implement a specific strategy, you need to set the strategy option when loading a Meergo SDK. For example, with the [JavaScript SDK](/integrations/sources/javascript-sdk) in the browser:
