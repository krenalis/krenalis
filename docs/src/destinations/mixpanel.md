...
{% macro Title string %}Mixpanel (Destination){% end %}
{% Article %}

# Mixpanel (Destination)

The destination connector for Mixpanel allows you to send events to Mixpanel.
...
* [Add destination connection for Mixpanel](#add-destination-connection-for-mixpanel)
* [Track user sessions](#track-user-sessions)

### Add destination connection for Mixpanel
...
Before you can add destination connection for Mixpanel, you need to retrieve the **Project ID** and **Project Token** for your Mixpanel project. To do this:
