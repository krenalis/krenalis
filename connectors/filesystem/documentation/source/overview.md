...
Using this connector you can import files that are in the file system of the installation that Krenalis is running on.

Its sole purpose is to test file imports and explore the various file formats supported by Krenalis, and it is strongly discouraged to use this connector in production, as it can freely access the file system.
