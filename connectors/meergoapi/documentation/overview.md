...
See the documentation of the Meergo APIs here: http://localhost:8080/api/.
...
The events can be streamed in real time to your data warehouse and to SaaS applications. Users data from events can be imported into the data warehouse to be consolidated into unified user profiles within Meergo.
