...
func Test_Columns(t *testing.T) {
	...
	expected := []connectors.Column{
		...
		{Name: "h", Type: types.String().WithByteLen(16_777_216).WithCharLen(16_777_216), Writable: true},
		{Name: "i", Type: types.String().WithCharLen(50), Nullable: true, Writable: true},
...
func Test_Merge_Query(t *testing.T) {
	...
	cols := []struct {
		...
		{"VARCHAR", "foo", types.String().WithByteLen(16_777_216).WithCharLen(16_777_216), "foo"},
