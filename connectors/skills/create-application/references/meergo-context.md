...
**Meergo** is a developer-first Customer Data Platform (CDP) that helps teams:
...
Meergo is connector-driven: integrations are compiled Go modules that run inside the Meergo server.

## What are connectors?

In Meergo, a **connector** is a Go package that is compiled into the Meergo executable and registered at init time. Connectors represent integrations for different "data problems", including:
