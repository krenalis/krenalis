...
4. Add the following setting to the `settings` column of the `FileStorage` connection: `{"Host":"192.168.1.2","Port":2222,"Username":"tester","Password":"password","Path":"/users.csv"}`
