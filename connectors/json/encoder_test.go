...
func TestEncoder(t *testing.T) {
	...
	var typ = types.Object([]types.Property{
		...
		{Name: "uint8", Type: types.Int(8).Unsigned()},
		{Name: "uint16", Type: types.Int(16).Unsigned()},
		{Name: "uint24", Type: types.Int(24).Unsigned()},
		{Name: "uint32", Type: types.Int(32).Unsigned()},
		{Name: "no_value_2", Type: types.Boolean()},
		{Name: "uint64", Type: types.Int(64).Unsigned()},
		...
		{Name: "object", Type: types.Object([]types.Property{
			...
			{Name: "b", Type: types.Object([]types.Property{
				...
				{Name: "b2", Type: types.Int(32).Unsigned()},
			})},
		})},
