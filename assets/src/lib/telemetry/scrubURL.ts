...
const REQUEST_PATTERNS = [
	...
	'/connections/:id/actions/schemas/Events/:type',
	'/connections/:id/event-write-keys',
	'/connections/:id/files/:path',
	'/connections/:id/files/:path/absolute',
	'/connections/:id/files/:path/sheets',
	'/connections/:id/schemas/event/:type',
	'/connections/:id/schemas/user',
	'/connections/:id/tables/:name',
	'/connections/:id/ui',
