...
func Test_validatePipeline(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "BAD: Source/Database/User - no user ID column specified",
			pipeline: PipelineToSet{
				Name: "Import users",
				InSchema: types.Object([]types.Property{
					{Name: "id", Type: types.Int(32)},
			...
			connectionRole:          state.Source,
			connectionConnectorType: state.Database,
			err:                     "user ID column is mandatory",
		},
		{
			name: "BAD: Source/Database/User - user ID column not found in input schema",
			pipeline: PipelineToSet{
				Name: "Import users",
				InSchema: types.Object([]types.Property{
					{Name: "timestamp", Type: types.DateTime()},
			...
			connectionRole:          state.Source,
			connectionConnectorType: state.Database,
			err:                     "user ID column \"id\" not found within input schema",
		},
		{
		...
		{
			name: "BAD: Source/Database/User - user ID column has invalid type",
			pipeline: PipelineToSet{
				Name: "Import users",
				InSchema: types.Object([]types.Property{
			...
			connectionRole:          state.Source,
			connectionConnectorType: state.Database,
			err:                     "user ID column \"id\" has kind array instead of int, uuid, json, or string",
		},
		{
			name: "BAD: Source/Application/User - cannot specify an user ID column",
			pipeline: PipelineToSet{
				Name: "Import users",
				InSchema: types.Object([]types.Property{
					{Name: "email_in", Type: types.String()},
				...
				UserIDColumn: "my_user_id_column",
			},
			target:                  state.TargetUser,
			connectionRole:          state.Source,
			connectionConnectorType: state.Application,
			err:                     "pipeline cannot specify a user ID column",
		},
		{
		...
		{
			name: "BAD: Source/Database/User - user ID column is not a valid property name",
			pipeline: PipelineToSet{
				Name: "Import users",
				InSchema: types.Object([]types.Property{
					{Name: "id", Type: types.Int(32)},
				...
				Query:           "SELECT id, timestamp, email_in FROM my_table",
				UserIDColumn:    "user id column",
				UpdatedAtColumn: "timestamp",
			},
			target:                  state.TargetUser,
			connectionRole:          state.Source,
			connectionConnectorType: state.Database,
			err:                     "user ID column is not a valid property name",
		},
		{
			name: "BAD: Source/Database/User - user ID column is too long",
			pipeline: PipelineToSet{
				Name: "Import users",
				InSchema: types.Object([]types.Property{
					{Name: "id", Type: types.Int(32)},
				...
				Query:           "SELECT id, timestamp, email_in FROM my_table",
				UserIDColumn:    strings.Repeat("c", 1025),
				UpdatedAtColumn: "timestamp",
			},
			target:                  state.TargetUser,
			connectionRole:          state.Source,
			connectionConnectorType: state.Database,
			err:                     "user ID column is longer than 1024 runes",
		},
		{
