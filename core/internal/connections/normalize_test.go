...
func Test_normalize(t *testing.T) {
	...
	tests := []struct {
		...
		{types.String().WithMaxBytes(3), "boo", "boo", false, nil},
		...
		{types.Int(8).Unsigned(), []byte(nil), nil, true, nil},
		// unsigned int(32).
		{types.Int(32).Unsigned(), uint(47303), uint(47303), false, nil},
		{types.Int(32).Unsigned(), 47303.0, uint(47303), false, nil},
		{types.Int(32).Unsigned(), []byte(nil), nil, true, nil},
		// unsigned int(64).
		{types.Int(64).Unsigned(), float64(0), uint(0), false, nil},
		{types.Int(64).Unsigned(), float32(0), uint(0), false, nil},
		{types.Int(64).Unsigned(), math.Nextafter(0x1p64, 0), uint(math.MaxUint64 - 2047), false, nil},
		{types.Int(64).Unsigned(), math.Nextafter32(0x1p64, 0), uint(math.MaxUint64 - (1<<40 - 1)), false, nil},
		// float(32).
		...
		// ip.
		{types.IP(), "127.0.0.1", "127.0.0.1", false, nil},
		{types.IP(), "192.168.1.10/24", "192.168.1.10", false, nil},
		...
		{types.IP(), net.ParseIP("2001:0db8:85a3:0000:0000:8a2e:0370:7334"), "2001:db8:85a3::8a2e:370:7334", false, nil},
		{types.IP(), net.ParseIP("::ffff:192.168.1.10"), "192.168.1.10", false, nil},
		...
		{types.Object([]types.Property{{Name: "foo", Type: types.IP(), Nullable: true}}), map[string]any{"foo": ""}, map[string]any{"foo": nil}, true, nil},
...
func Test_normalize_errors(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "textTooLong", typ: types.String().WithMaxBytes(1), value: "toolong", wantContains: "has a value longer than 1 bytes"},
		...
		{name: "intFloat64Huge", typ: types.Int(64), value: math.MaxFloat64, wantContains: "has a float64 value that cannot represent an int(64) value"},
		...
		{name: "intFloat64Inf", typ: types.Int(64), value: math.Inf(1), wantContains: "has a float64 value that cannot represent an int(64) value"},
		...
		{name: "intFloat32Huge", typ: types.Int(64), value: float32(math.MaxFloat32), wantContains: "has a float32 value that cannot represent an int(64) value"},
		...
		{name: "intFloat32Inf", typ: types.Int(64), value: float32(math.Inf(-1)), wantContains: "has a float32 value that cannot represent an int(64) value"},
		...
		{name: "unsignedNegativeInt", typ: types.Int(8).Unsigned(), value: -3, wantContains: "has a negative int value that cannot represent an unsigned int(8) value"},
		{name: "unsignedAboveRange", typ: types.Int(8).Unsigned(), value: uint16(math.MaxUint16), wantContains: "has value which is not in the range [0, 255]"},
		{name: "unsignedStringParseError", typ: types.Int(16).Unsigned(), value: "bad", wantContains: "has a string value that cannot represent an unsigned int value"},
		...
		{name: "inetInvalidString", typ: types.IP(), value: "999.999.1.1", wantContains: "has a string value that cannot represent a valid ip value"},
		{name: "inetInvalidIP", typ: types.IP(), value: net.IP{}, wantContains: "has a net.IP value that cannot represent a valid ip value"},
		{name: "inetInvalidType", typ: types.IP(), value: 5, wantContains: "has type int that is not allowed for type ip"},
