...
func Test_Unmarshal(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			records:  []Record{{Purpose: Create, Err: newRecordValidationError("Object.b", `key «Object.b» is missing but it is required for creation`)}},
		},
		{
			language: state.Python,
			schema:   schema,
			data:     `{"records":[{"value":{"Object":{"a":true}}}]}`,
			records:  []Record{{Purpose: Update, Err: newRecordValidationError("Object.c", `key «Object.c» is missing but it is required for update`)}},
		},
		{
			language: state.JavaScript,
			schema:   schema,
		...
		},
		{
			...
			records:  []Record{{Err: newRecordValidationError("Boolean", `key «Boolean» has a value that is not of type «bool»`)}},
		},
		{
			language: state.Python,
			schema:   schema,
			data:     `{"records":[{"value":{"Boolean":null}}]}`,
			records:  []Record{{Err: newRecordValidationError("Boolean", `key «Boolean» cannot be «None», but it is set to «None»`)}},
		},
		{
			language: state.Python,
			schema:   schema,
			data:     `{"records":[{"value":{"Date":"2023-02-30"}}]}`,
			records:  []Record{{Err: newRecordValidationError("Date", `key «Date» has a value that is not of type «datetime.date»`)}},
		},
		{
			language: state.Python,
			schema:   schema,
			data:     `{"records":[{"value":{"Text":"some long text"}}]}`,
			records:  []Record{{Err: newRecordValidationError("Text", `key «Text» exceeds the 10-char limit`)}},
		},
		{
			language: state.Python,
			schema:   schema,
		...
		},
		{
			...
			records:  []Record{{Err: newRecordValidationError("Text_values", `key «Text_values» is not one of the allowed values`)}},
		},
		{
			language: state.Python,
			schema:   schema,
		...
		},
		{
			...
			records:  []Record{{Err: newRecordValidationError("Text_regexp", `key «Text_regexp» does not match «/o\/o$/»`)}},
		},
		{
			language: state.Python,
			schema:   schema,
		...
		},
		{
			...
			records:  []Record{{Purpose: Update, Err: newRecordValidationError("Object.c", `key «Object.c» is missing but it is required for update`)}, {Properties: map[string]any{"Int32": 547}}},
		},
		{
			language: state.JavaScript,
			schema:   schema,
		...
		},
		{
			...
			records: []Record{
				{Err: newRecordValidationError("Boolean", `key «Boolean» has a value that is not of type «bool»`)},
				{Purpose: Create, Err: newRecordValidationError("Object.b", `key «Object.b» is missing but it is required for creation`)},
			},
		},
		{
			language: state.JavaScript,
		...
		},
		{
			...
			records:  []Record{{Err: newRecordValidationError("Object", `key «Object» has a value that is not of type «dict»`)}},
		},
		{
			language: state.JavaScript,
			schema:   schema,
