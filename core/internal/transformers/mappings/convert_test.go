...
func TestConvert(t *testing.T) {
	...
	tests := []struct {
		...
		// text.
		{types.Int(32), types.Text(), nil, nil, true, nil, nil},
		{types.Text(), types.Text(), "foo", "foo", true, nil, nil},
		{types.Text(), types.Text().WithValues("foo", "boo"), "", nil, true, nil, nil},
		{types.Text(), types.Text().WithValues("foo", "boo"), "boo", "boo", true, nil, nil},
		{types.Text(), types.Text().WithRegexp(regexp.MustCompile(`^bo+$`)), "", nil, true, nil, nil},
		{types.Text(), types.Text().WithRegexp(regexp.MustCompile(`^bo+$`)), "boo", "boo", true, nil, nil},
		{types.Boolean(), types.Text(), true, "true", true, nil, nil},
		{types.Int(32), types.Text(), -603, "-603", true, nil, nil},
		{types.Float(64), types.Text(), 7928301735.704827, "7.928301735704827e+09", true, nil, nil},
		{types.Float(32), types.Text(), 3.14, "3.14", true, nil, nil},
		{types.Decimal(5, 2), types.Text(), decimal.MustParse("120.79"), "120.79", true, nil, nil},
		{types.DateTime(), types.Text(), time.Date(2023, 5, 24, 9, 1, 57, 493614090, time.UTC), "2023-05-24T09:01:57.49361409Z", true, nil, nil},
		{types.DateTime(), types.Text(), time.Date(2023, 5, 24, 9, 1, 57, 0, time.UTC), "2023-05-24T09:01:57Z", true, nil, nil},
		{types.Date(), types.Text(), time.Date(2023, 5, 24, 0, 0, 0, 0, time.UTC), "2023-05-24", true, nil, nil},
		{types.Time(), types.Text(), time.Date(1970, 1, 1, 9, 1, 57, 493614090, time.UTC), "09:01:57.49361409", true, nil, nil},
		{types.Time(), types.Text(), time.Date(1970, 1, 1, 9, 1, 57, 0, time.UTC), "09:01:57", true, nil, nil},
		{types.Year(), types.Text(), 1, "1", true, nil, nil},
		{types.Year(), types.Text(), 2023, "2023", true, nil, nil},
		{types.UUID(), types.Text(), "123e4567-e89b-12d3-a456-426614174000", "123e4567-e89b-12d3-a456-426614174000", true, nil, nil},
		{types.Inet(), types.Text(), "2001:db8::ff00:42:8329", "2001:db8::ff00:42:8329", true, nil, nil},
		{types.JSON(), types.Text(), json.Value(`"foo"`), "foo", true, nil, nil},
		{types.JSON(), types.Text(), json.Value("23.8013"), "23.8013", true, nil, nil},
		{types.JSON(), types.Text(), json.Value("812"), "812", true, nil, nil},
		{types.JSON(), types.Text(), json.Value("true"), "true", true, nil, nil},
		{types.JSON(), types.Text(), json.Value("null"), nil, true, nil, nil},
		...
		{types.Int(8), types.Boolean(), -1, true, true, nil, nil},
		{types.Uint(8), types.Boolean(), uint(0), false, true, nil, nil},
		{types.Uint(8), types.Boolean(), uint(1), true, true, nil, nil},
		{types.Text(), types.Boolean(), "false", false, true, nil, nil},
		{types.Text(), types.Boolean(), "False", false, true, nil, nil},
		{types.Text(), types.Boolean(), "FALSE", false, true, nil, nil},
		{types.Text(), types.Boolean(), "no", false, true, nil, nil},
		{types.Text(), types.Boolean(), "No", false, true, nil, nil},
		{types.Text(), types.Boolean(), "NO", false, true, nil, nil},
		{types.Text(), types.Boolean(), "true", true, true, nil, nil},
		{types.Text(), types.Boolean(), "True", true, true, nil, nil},
		{types.Text(), types.Boolean(), "TRUE", true, true, nil, nil},
		{types.Text(), types.Boolean(), "yes", true, true, nil, nil},
		{types.Text(), types.Boolean(), "Yes", true, true, nil, nil},
		{types.Text(), types.Boolean(), "YES", true, true, nil, nil},
		...
		{types.Uint(8), types.Int(32), uint(7), 7, true, nil, nil},
		{types.Int(16), types.Int(32), -29, -29, true, nil, nil},
		{types.Uint(24), types.Int(32), uint(89302), 89302, true, nil, nil},
		...
		{types.Text(), types.Int(32), "502842", 502842, true, nil, nil},
		{types.Text(), types.Int(32), "", nil, true, nil, nil},
		...
		// uint.
		{types.Int(32), types.Uint(32), 831, uint(831), true, nil, nil},
		{types.Int(32), types.Uint(8), 218, uint(218), true, nil, nil},
		{types.Int(32), types.Uint(16), 2571, uint(2571), true, nil, nil},
		{types.Int(32), types.Uint(24), 670329, uint(670329), true, nil, nil},
		{types.Uint(32), types.Uint(64), uint(math.MaxUint32), uint(math.MaxUint32), true, nil, nil},
		{types.Uint(8), types.Uint(32), uint(7), uint(7), true, nil, nil},
		{types.Uint(16), types.Uint(32), uint(29), uint(29), true, nil, nil},
		{types.Uint(24), types.Uint(32), uint(89302), uint(89302), true, nil, nil},
		{types.Float(64), types.Uint(64), maxFloatConvertibleToUint64, uint(18446744073709549568), true, nil, nil},
		{types.Decimal(60, 0), types.Uint(64), maxUintDecimal, uint(math.MaxUint64), true, nil, nil},
		{types.Year(), types.Uint(16), 2020, uint(2020), true, nil, nil},
		{types.Text(), types.Uint(32), "502842", uint(502842), true, nil, nil},
		{types.JSON(), types.Uint(32), json.Value("15"), uint(15), true, nil, nil},
		{types.Boolean(), types.Uint(8), false, uint(0), true, nil, nil},
		{types.Boolean(), types.Uint(8), true, uint(1), true, nil, nil},
		...
		{types.Uint(8), types.Float(32), uint(256), float64(float32(256)), true, nil, nil},
		{types.Decimal(20, 10), types.Float(64), decimal.MustParse("767.5018382257"), 767.5018382257, true, nil, nil},
		{types.Text(), types.Float(64), "767.5018382257", 767.5018382257, true, nil, nil},
		...
		{types.Uint(8), types.Decimal(3, 0), uint(math.MaxUint8), decimal.MustInt(math.MaxUint8), true, nil, nil},
		...
		{types.Text(), types.Decimal(20, 10), "1048294.202936601", decimal.MustParse("1048294.202936601"), true, nil, nil},
		...
		{types.Text(), types.DateTime(), "2023-05-24T09:01:57.49361409Z", time.Date(2023, 5, 24, 9, 1, 57, 493614090, time.UTC), true, nil, nil},
		{types.Text(), types.DateTime(), "2023-05-24T09:01:57-07:00", time.Date(2023, 5, 24, 16, 1, 57, 0, time.UTC), true, nil, nil},
		...
		{types.Text(), types.DateTime(), "2023-05-24T09:01:57.49361409Z", "Wed, 24 May 2023 09:01:57 +0000", true, &state.TimeLayouts{DateTime: time.RFC1123Z}, nil},
		{types.DateTime(), types.DateTime(), time.Date(2023, 5, 24, 9, 1, 57, 493614090, time.UTC), time.Date(2023, 5, 24, 9, 1, 57, 493614090, time.UTC), true, nil, nil},
		...
		{types.Text(), types.Date(), "2023-05-24", time.Date(2023, 5, 24, 0, 0, 0, 0, time.UTC), true, nil, nil},
		...
		{types.Text(), types.Date(), "2023-05-24", "05/24/2023", true, &state.TimeLayouts{Date: "01/02/2006"}, nil},
		...
		{types.Text(), types.Time(), "09:01:57.49361409Z", time.Date(1970, 1, 1, 9, 1, 57, 493614090, time.UTC), true, nil, nil},
		{types.Text(), types.Time(), "09:01:57", time.Date(1970, 1, 1, 9, 1, 57, 0, time.UTC), true, nil, nil},
		...
		{types.Uint(64), types.Year(), uint(9999), 9999, true, nil, nil},
		{types.Text(), types.Year(), "2023", 2023, true, nil, nil},
		{types.Text(), types.Year(), "1", 1, true, nil, nil},
		...
		{types.Text(), types.UUID(), "123e4567-e89b-12d3-a456-426614174000", "123e4567-e89b-12d3-a456-426614174000", true, nil, nil},
		...
		{types.Text(), types.JSON(), "", json.Value(`""`), false, nil, nil},
		...
		{types.Text(), types.Inet(), "2001:0db8:0000:0000:0000:ff00:0042:8329", "2001:db8::ff00:42:8329", true, nil, nil},
		...
		{types.Array(types.Text()), types.Array(types.Text()), []any{"123e4567-e89b-12d3-a456-426614174000"}, []any{"123e4567-e89b-12d3-a456-426614174000"}, true, nil, nil},
		...
		{types.JSON(), types.Array(types.Text()), json.Value(`"foo"`), []any{"foo"}, true, nil, nil},
		{types.JSON(), types.Array(types.Float(64)), json.Value(`15.07`), []any{15.07}, true, nil, nil},
		{types.Text(), types.Array(types.Float(64)), "foo", nil, false, nil, errInvalidConversion},
		...
		{types.Map(types.Boolean()), types.Object([]types.Property{{Name: "x", Type: types.Text()}, {Name: "y", Type: types.Boolean()}}), map[string]any{"x": true, "y": false}, map[string]any{"x": "true", "y": false}, true, nil, nil},
		{types.Int(32), types.Object([]types.Property{{Name: "x", Type: types.Text()}}), 56, nil, false, nil, errInvalidConversion},
		...
		{types.JSON(), types.Map(types.Float(32)), json.Value(`{"a":4032,"b":-721}`), map[string]any{"a": float64(float32(4032)), "b": float64(float32(-721))}, true, nil, nil},
		{types.Object([]types.Property{{Name: "foo", Type: types.Int(32)}}), types.Map(types.Text()), map[string]any{"foo": 572}, map[string]any{"foo": "572"}, true, nil, nil},
		{types.Text(), types.Map(types.Text()), "boo", nil, false, nil, errInvalidConversion},
	}
