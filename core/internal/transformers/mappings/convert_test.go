...
func TestConvert(t *testing.T) {
	...
	tests := []struct {
		...
		{types.String(), types.String().WithRegexp(regexp.MustCompile(`^bo+$`)), "", nil, true, nil, nil},
		{types.String(), types.String().WithRegexp(regexp.MustCompile(`^bo+$`)), "boo", "boo", true, nil, nil},
		...
		{types.String(), types.Uint(32), "502842", uint(502842), true, nil, nil},
