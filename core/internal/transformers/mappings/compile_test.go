...
func Test_Compile(t *testing.T) {
	...
	schema := types.Object([]types.Property{
		{Name: "manufacturer", Type: types.String()},
	...
	tests := []struct {
		...
		{expr: " \n \t\t ", dt: types.String(), compileErr: errors.New("expression is empty")},
		{expr: "null", dt: types.Int(32), nullable: true, expected: nil},
		{expr: "null", dt: types.Int(32), nullable: false, expected: nil},
		{expr: "engine.afterburner", dt: types.String(), nullable: true, expected: nil},
		{expr: "engine.afterburner", dt: types.String(), nullable: false, expected: nil},
		...
		{expr: "''", dt: types.Map(types.String()), compileErr: errors.New("\"\" is not convertible to the map(string) type")},
		{expr: "' '   '  '", dt: types.String(), expected: "   "},
		{expr: "''", dt: types.JSON(), expected: json.Value(`""`)},
		{expr: "'100'", dt: types.JSON(), expected: json.Value(`"100"`)},
		{expr: "'42'", dt: types.Int(32), expected: 42},
		{expr: "'42'", dt: types.String(), expected: "42"},
		{expr: "'Afterburner: ' coalesce('yes', 'no afterburner')", dt: types.String(), expected: "Afterburner: yes"},
		{expr: "'Afterburner: ' coalesce(engine.afterburner, 'no afterburner')", dt: types.String(), expected: "Afterburner: no afterburner"},
		{expr: "'Afterburner: ' coalesce(engine.afterburner, engine.afterburner, 'no afterburner')", dt: types.String(), expected: "Afterburner: no afterburner"},
		{expr: "42", dt: types.Int(32), expected: 42},
		{expr: "42", dt: types.JSON(), expected: json.Value("42")},
		{expr: "42", dt: types.String(), expected: "42"},
		{expr: "cx cx", dt: types.String(), expected: "0.1420.142"},
		{expr: "engine.name", dt: types.String(), expected: "TurboX"},
		{expr: "engine.power ' x ' 1.36", dt: types.String(), expected: "7000 x 1.36"},
		...
		{expr: "manufacturer ' ' model", dt: types.String(), expected: "MyPlaneCompany SuperFast"},
		{expr: "manufacturer", dt: types.JSON(), expected: json.Value(`"MyPlaneCompany"`)},
		{expr: "manufacturer", dt: types.String(), expected: "MyPlaneCompany"},
		...
		{expr: "'Engine power: ' (coalesce engine.power, 0)", dt: types.String(), compileErr: errors.New("unexpected character '('")},
		{expr: "'Engine power: ' coalesce engine.power", dt: types.String(), compileErr: errors.New(`property "coalesce" does not exist`)},
		{expr: "'Engine power: engine.power", dt: types.String(), compileErr: errors.New("string is not terminated")},
		...
		{expr: "true", dt: types.Int(32), compileErr: errors.New("true is not convertible to the int(32) type")},
		{expr: "engine", dt: types.Object([]types.Property{{Name: "notfound", Type: types.String()}}), compileErr: errors.New("cannot convert expression (type object) to object")},
		...
		{expr: "revision_dates", dt: types.Array(types.Boolean()), compileErr: errors.New("cannot convert expression (type array(datetime)) to array(boolean)")},
		{expr: "map", dt: types.Map(types.Date()), compileErr: errors.New("cannot convert expression (type map(int(32))) to map(date)")},
		...
		{expr: "manufacturer.power", dt: types.Int(32), compileErr: errors.New(`invalid manufacturer.power: manufacturer (type string) cannot have properties or keys`)},
		...
		{expr: "and(1, true)", dt: types.Boolean(), compileErr: errors.New("1 is not convertible to the boolean type")},
		...
		{expr: "array('foo', true, 5)", dt: types.Array(types.String()), nullable: false, expected: []any{"foo", "true", "5"}},
		...
		{expr: "array(null)", dt: types.Array(types.String()), compileErr: errors.New("null is not convertible to the string type")},
		...
		{expr: "0 coalesce(null, 2)", dt: types.String(), nullable: true, expected: "02"},
		...
		{expr: "coalesce(1, 2)", dt: types.Boolean(), nullable: true, compileErr: errors.New("1 is not convertible to the boolean type")},
		...
		{expr: "if(1, 2)", dt: types.Int(32), compileErr: errors.New("1 is not convertible to the boolean type")},
		{expr: "if(false, null)", dt: types.Int(32), expected: nil},
		{expr: "if(true, 1, null)", dt: types.Int(32), expected: 1},
		{expr: "if(false, 2)", dt: types.Boolean(), compileErr: errors.New("2 is not convertible to the boolean type")},
		...
		{expr: "initcap(true)", dt: types.String(), expected: "True"},
		...
		// lower.
		{expr: "lower('')", dt: types.String(), expected: ""},
		{expr: "lower('New York')", dt: types.String(), expected: "new york"},
		{expr: "lower('new york')", dt: types.String(), expected: "new york"},
		{expr: "lower()", dt: types.String(), compileErr: errors.New("'lower' function requires a single argument")},
		{expr: "lower('New', 'York')", dt: types.String(), compileErr: errors.New("'lower' function requires a single argument")},
		{expr: "lower(false)", dt: types.String(), expected: "false"},

		// ltrim.
		{expr: "ltrim('')", dt: types.String(), expected: ""},
		{expr: "ltrim('New York')", dt: types.String(), expected: "New York"},
		{expr: "ltrim(' New York\t\n')", dt: types.String(), expected: "New York\t\n"},
		{expr: "ltrim('\t\n \nNew \n York ')", dt: types.String(), expected: "New \n York "},
		{expr: "ltrim()", dt: types.String(), compileErr: errors.New("'ltrim' function requires a single argument")},
		{expr: "ltrim(' New', 'York ')", dt: types.String(), compileErr: errors.New("'ltrim' function requires a single argument")},
		{expr: "ltrim(null)", dt: types.String(), expected: nil},
		{expr: "ltrim(12.67)", dt: types.String(), expected: "12.67"},
		...
		{expr: "map(1, true)", dt: types.Map(types.JSON()), compileErr: errors.New("'map' key is not string")},
		...
		// rtrim.
		{expr: "rtrim('')", dt: types.String(), expected: ""},
		{expr: "rtrim('New York')", dt: types.String(), expected: "New York"},
		{expr: "rtrim(' New York\t\n')", dt: types.String(), expected: " New York"},
		{expr: "rtrim(' New \n York\t\n \n')", dt: types.String(), expected: " New \n York"},
		{expr: "rtrim()", dt: types.String(), compileErr: errors.New("'rtrim' function requires a single argument")},
		{expr: "rtrim(' New', 'York ')", dt: types.String(), compileErr: errors.New("'rtrim' function requires a single argument")},
		{expr: "rtrim(null)", dt: types.String(), expected: nil},

		// substring.
		{expr: "substring('Hello World', 7, 5)", dt: types.String(), expected: "World"},
		{expr: "substring('Hello World', -5, 5)", dt: types.String(), expected: "Hello"},
		{expr: "substring('Hello World', 0)", dt: types.String(), expected: "Hello World"},
		{expr: "substring(null, 3, 12)", dt: types.String(), expected: nil},
		{expr: "substring('Hello World', null, 12)", dt: types.String(), expected: nil},
		{expr: "substring('Hello World', 3, null)", dt: types.String(), expected: nil},
		{expr: "substring('Hello World', null)", dt: types.String(), expected: nil},
		{expr: "substring('Hello World', 3, -2)", dt: types.String(), evalErr: errors.New("substring: negative substring length is not allowed")},
		{expr: "substring(250, 2, 2)", dt: types.Int(32), expected: 50},
		{expr: "substring('Hello World', 'a', 2)", dt: types.Int(32), compileErr: errors.New(`"a" is not convertible to the int(32) type`)},
		{expr: "substring('Hello World', 0, 'b')", dt: types.Int(32), compileErr: errors.New(`"b" is not convertible to the int(32) type`)},
		...
		{expr: "or(1, true)", dt: types.Boolean(), compileErr: errors.New("1 is not convertible to the boolean type")},
		...
		// trim.
		{expr: "trim('')", dt: types.String(), expected: ""},
		{expr: "trim('New York')", dt: types.String(), expected: "New York"},
		{expr: "trim(' New York\t\n')", dt: types.String(), expected: "New York"},
		{expr: "trim('\t\n \r\nNew \n York  ')", dt: types.String(), expected: "New \n York"},
		{expr: "trim()", dt: types.String(), compileErr: errors.New("'trim' function requires a single argument")},
		{expr: "trim(' New', 'York ')", dt: types.String(), compileErr: errors.New("'trim' function requires a single argument")},
		{expr: "trim(null)", dt: types.String(), expected: nil},
		{expr: "trim(55)", dt: types.String(), expected: "55"},

		// upper.
		{expr: "upper('')", dt: types.String(), expected: ""},
		{expr: "upper('New York')", dt: types.String(), expected: "NEW YORK"},
		{expr: "upper('NEW YORK')", dt: types.String(), expected: "NEW YORK"},
		{expr: "upper()", dt: types.String(), compileErr: errors.New("'upper' function requires a single argument")},
		{expr: "upper('New', 'York')", dt: types.String(), compileErr: errors.New("'upper' function requires a single argument")},
		{expr: "upper(false)", dt: types.String(), expected: "FALSE"},
	}
...
func Test_typeOf(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "path only",
			expr:     []part{{path: path{elements: []string{"name"}, decorators: []decorators{0}}, typ: types.String()}},
			expected: types.String(),
		},
		{
			name:     "value and path",
			expr:     []part{{value: "foo", path: path{elements: []string{"name"}, decorators: []decorators{0}}, typ: types.String()}},
			expected: types.String(),
		},
		{
			name:     "multiple parts",
			expr:     []part{{value: "foo", typ: types.String()}, {value: "bar", typ: types.String()}},
			expected: types.String(),
		},
	}
