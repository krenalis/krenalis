...
func Test_checkSchemaAlignment(t *testing.T) {
	...
	tests := []struct {
		...
		{p1: types.Property{Type: types.String().WithCharLen(100)}, p2: types.Property{Type: types.String().WithCharLen(100)}},
		{p1: types.Property{Type: types.String().WithByteLen(50)}, p2: types.Property{Type: types.String().WithByteLen(50)}},
		...
		{p1: types.Property{Type: types.String().WithRegexp(regexp.MustCompile(`^\d+`)).WithByteLen(10)}, p2: types.Property{Type: types.String().WithRegexp(regexp.MustCompile(`^\d+`)).WithByteLen(10)}},
		...
		{p1: types.Property{Type: types.Map(types.String().WithCharLen(60))}, p2: types.Property{Type: types.Map(types.String().WithCharLen(60))}},
		{p1: types.Property{Type: types.String()}, p2: types.Property{Type: types.String().WithCharLen(100)}, err: `character length of the "foo" property's type has changed from unbounded to 100`},
		{p1: types.Property{Type: types.String().WithCharLen(5)}, p2: types.Property{Type: types.String()}, err: `character length of the "foo" property's type has changed from 5 to unbounded`},
		{p1: types.Property{Type: types.String().WithCharLen(50)}, p2: types.Property{Type: types.String().WithCharLen(60)}, err: `character length of the "foo" property's type has changed from 50 to 60`},
		{p1: types.Property{Type: types.String()}, p2: types.Property{Type: types.String().WithByteLen(500)}, err: `byte length of the "foo" property's type has changed from unbounded to 500`},
		{p1: types.Property{Type: types.String().WithByteLen(8)}, p2: types.Property{Type: types.String()}, err: `byte length of the "foo" property's type has changed from 8 to unbounded`},
		{p1: types.Property{Type: types.String().WithByteLen(1200)}, p2: types.Property{Type: types.String().WithByteLen(1250)}, err: `byte length of the "foo" property's type has changed from 1200 to 1250`},
