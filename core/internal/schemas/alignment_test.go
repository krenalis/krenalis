...
func Test_checkSchemaAlignment(t *testing.T) {
	...
	tests := []struct {
		...
		{p1: types.Property{Type: types.Int(16).Unsigned().WithUnsignedRange(0, 100)}, p2: types.Property{Type: types.Int(16).Unsigned().WithUnsignedRange(0, 100)}},
		{p1: types.Property{Type: types.Float(64)}, p2: types.Property{Type: types.Float(64)}},
		{p1: types.Property{Type: types.Float(32).Real()}, p2: types.Property{Type: types.Float(32).Real()}, mode: &createOnlyMode},
		...
		{p1: types.Property{Type: types.String()}, p2: types.Property{Type: types.String().WithMaxBytes(500)}, err: `byte length of the "foo" property's type has changed from unbounded to 500`},
		{p1: types.Property{Type: types.String().WithMaxBytes(8)}, p2: types.Property{Type: types.String()}, err: `byte length of the "foo" property's type has changed from 8 to unbounded`},
		{p1: types.Property{Type: types.String().WithMaxBytes(1200)}, p2: types.Property{Type: types.String().WithMaxBytes(1250)}, err: `byte length of the "foo" property's type has changed from 1200 to 1250`},
		...
		{p1: types.Property{Type: types.Int(16).Unsigned()}, p2: types.Property{Type: types.Int(8).Unsigned()}, err: `"foo" property's type has changed from int(16) to int(8)`},
		...
		{p1: types.Property{Type: types.Int(16).Unsigned().WithUnsignedRange(0, 10)}, p2: types.Property{Type: types.Int(16).Unsigned().WithUnsignedRange(0, 20)}, err: `range of the "foo" property's type has changed from [0,10] to [0,20]`},
		...
		{p1: types.Property{Type: types.Float(32).Real()}, p2: types.Property{Type: types.Float(32)}, err: `"foo" property's type has changed from real to non-real`},
		{p1: types.Property{Type: types.Float(64)}, p2: types.Property{Type: types.Float(64).Real()}, err: `"foo" property's type has changed from non-real to real`},
