	...
	tests := []struct {
	...
	}{
		{
			...
			expected: []Record{
				...
				{ID: "a415976f-279e-4653-ab6a-64ea7f74e174", Properties: map[string]any{"age": 12, "id": "7", "name": "Daniel Brown"}, Err: errors.New("The user has the same «id» (the matching property) as other users selected for export")},
				{ID: "ce8f366d-7144-4ec0-96e7-d0dc35597c02", Properties: map[string]any{"age": 77, "id": "7", "name": "James Williams"}, Err: errors.New("The user has the same «id» (the matching property) as other users selected for export")},
			},
		},
		{
			mode:               state.CreateOnly,
		...
		},
		{
			...
			expected: []Record{
				...
				{ID: "243abf79-cbc3-4c6e-8739-e1406f2f6b51", ExternalID: "Ex2", Properties: map[string]any{"age": 19, "id": "2", "name": "Sophia Harris"}, Err: errors.New("The user has the same «id» (the matching property) as other users selected for export")},
				{ID: "943a0a39-fd0b-4f7b-a113-59046fb8a511", ExternalID: "Ex2", Properties: map[string]any{"age": 58, "id": "2", "name": "Emily Davis"}, Err: errors.New("The user has the same «id» (the matching property) as other users selected for export")},
