...
func Test_validateAction(t *testing.T) {
	...
	tests := []struct {
		...
		connectionConnectorTargets state.ConnectorTargets
		...
		},
		{
			...
			connectionConnectorTargets: state.UsersFlag | state.EventsFlag,
		},
		{
		...
		},
		{
			...
			connectionRole:             state.Source,
			connectionConnectorType:    state.App,
			connectionConnectorTargets: state.UsersFlag | state.GroupsFlag,
		},
		{
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			v.connection.connector.targets = test.connectionConnectorTargets
