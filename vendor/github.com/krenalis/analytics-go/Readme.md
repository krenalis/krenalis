...
[![Go Reference](https://pkg.go.dev/badge/github.com/krenalis/analytics-go.svg)](https://pkg.go.dev/github.com/krenalis/analytics-go)

The Krenalis Go SDK lets you send customer event data from your Go applications to your specified destinations.
...
```bash
go get github.com/krenalis/analytics-go
```
...
func main() {
    // Instantiates a client to send messages to the Krenalis API.
...
The Krenalis Go SDK is released under the [MIT license](License.md).
