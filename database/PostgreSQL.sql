...
CREATE TABLE workspaces (
    ...
    update_user_schema_id uuid,
    update_user_schema_schema jsonb NOT NULL DEFAULT 'null'::jsonb,
    update_user_schema_primary_sources jsonb,
    update_user_schema_re_paths jsonb,
    update_user_schema_operations jsonb,
    update_user_schema_start_time timestamp(3),
    update_user_schema_end_time timestamp(3),
    update_user_schema_error varchar,
