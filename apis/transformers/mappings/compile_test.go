...
func Test_Compile(t *testing.T) {
	...
	tests := []struct {
		...
		{expr: "engine.power ' x ' 1.36", dt: types.Text(), expectedValue: "7000 x 1.36"},
		{expr: "engine['power']", dt: types.Float(64), expectedValue: 7000.0},
		{expr: "engine", dt: types.JSON(), expectedValue: json.RawMessage(`{"afterburner":null,"name":"TurboX","power":7000}`)},
		...
		{expr: "and(null, false)", dt: types.Boolean(), expectedValue: false},
		{expr: "and(true, null)", dt: types.Boolean(), expectedValue: nil},
		...
		{expr: "array(null)", dt: types.Array(types.JSON()), expectedValue: []any{json.RawMessage("null")}},
		...
		{expr: "coalesce(null, null)", dt: types.Int(32), nullable: false, expectedValue: nil},
		...
		{expr: "eq(1, '1')", dt: types.Boolean(), expectedValue: true},
		{expr: "eq('1', 1)", dt: types.Boolean(), expectedValue: true},
		{expr: "eq(1, null)", dt: types.Boolean(), nullable: true, expectedValue: nil},
		{expr: "eq(null, 2)", dt: types.Boolean(), nullable: true, expectedValue: nil},
		...
		{expr: "if(null, 1, 2)", dt: types.Int(32), expectedValue: 2},
		{expr: "if(true, 1)", dt: types.Int(32), expectedValue: 1},
		{expr: "if(false, 1)", dt: types.Int(32), expectedValue: nil},
		{expr: "if(null, 1)", dt: types.Int(32), expectedValue: nil},
		...
		// len.
		{expr: "len('')", dt: types.Int(32), expectedValue: 0},
		{expr: "len('Hello World')", dt: types.Int(32), expectedValue: 11},
		{expr: "len(array(1, 2, 3))", dt: types.Int(32), expectedValue: 3},
		{expr: "len(map)", dt: types.Int(32), expectedValue: 2},
		{expr: "len(engine)", dt: types.Int(32), expectedValue: 3},
		{expr: "len(null)", dt: types.Int(32), expectedValue: 0},
		{expr: "len(engine.power)", dt: types.Int(32), expectedValue: 4},
		{expr: "len(passengers)", dt: types.Int(32), expectedValue: 3},
		{expr: "len(deep)", dt: types.Int(32), expectedValue: 1},
		{expr: "len(cx)", dt: types.Int(32), expectedValue: 5},
		{expr: "len(other)", dt: types.Int(32), expectedValue: 0},
		{expr: "len(properties)", dt: types.Int(32), expectedValue: 10},
		{expr: "len(jsonNull)", dt: types.Int(32), expectedValue: 0},
		{expr: "len(jsonNil)", dt: types.Int(32), expectedValue: 0},
