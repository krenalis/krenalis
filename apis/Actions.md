...
| Source **FileStorage** on **Users / Groups**               | —                                           | Read from file columns / headers                     | `users` schema (with no meta properties)  | File path and sheet, connector, connector settings, compression, identity column and (optionally) a timestamp column |
