...
| Source **Database** on **Users / Groups**                  | —                                           | Generated by executing the query                     | `users` schema (with no meta properties)  | Query                                                                                                 |
| Source **File** on **Users / Groups**                      | —                                           | Read from file columns / headers                     | `users` schema (with no meta properties)  | File path and sheet, identity column and (optionally) a timestamp column                              |
