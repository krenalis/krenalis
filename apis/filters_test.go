	...
	}{
		{
			...
			expected: state.Where{
				...
				Conditions: []state.WhereCondition{
					{Property: "a", Operator: state.OpIsTrue},
					{Property: "b", Operator: state.OpIs, Values: []any{-105}},
					{Property: "c", Operator: state.OpIsNot, Values: []any{uint(197)}},
					{Property: "d", Operator: state.OpIsGreaterThan, Values: []any{float64(float32(3.802))}},
					{Property: "e", Operator: state.OpIsGreaterThan, Values: []any{60526.80201845521}},
					{Property: "e", Operator: state.OpIsLessThan, Values: []any{1.7976931348623157e+308}},
					{Property: "f", Operator: state.OpIsLessThanOrEqualTo, Values: []any{decimal.RequireFromString("12.956")}},
					{Property: "g", Operator: state.OpIsAfter, Values: []any{time.Date(2024, 9, 19, 14, 36, 57, 264699103, time.UTC)}},
					{Property: "h", Operator: state.OpIsBetween, Values: []any{time.Date(2024, 9, 19, 0, 0, 0, 0, time.UTC), time.Date(2025, 9, 19, 0, 0, 0, 0, time.UTC)}},
					{Property: "i", Operator: state.OpIsBefore, Values: []any{time.Date(1970, 1, 1, 14, 36, 57, 264699103, time.UTC)}},
					{Property: "j", Operator: state.OpIsOnOrAfter, Values: []any{2024}},
					{Property: "k", Operator: state.OpIs, Values: []any{"38d065ab-ca46-4812-a83c-a9712e09c153"}},
					{Property: "l", Operator: state.OpIs, Values: []any{state.JSONConditionValue{String: "foo"}}},
					{Property: "l", Operator: state.OpIsOneOf, Values: []any{
						state.JSONConditionValue{String: "foo"},
						state.JSONConditionValue{String: "56.19", Number: &d},
						state.JSONConditionValue{String: "boo"},
					}},
					{Property: "l.x", Operator: state.OpExists},
					{Property: "m", Operator: state.OpIsNot, Values: []any{"192.168.1.1"}},
					{Property: "n", Operator: state.OpIs, Values: []any{"boo"}},
					{Property: "o", Operator: state.OpIsNull},
					{Property: "o", Operator: state.OpContains, Values: []any{"boo"}},
					{Property: "p", Operator: state.OpIsNot},
					{Property: "p.x", Operator: state.OpIs, Values: []any{"foo"}},
					{Property: "p.x.y", Operator: state.OpExists},
					{Property: "q", Operator: state.OpIsNull},
				},
			},
		},
		{
