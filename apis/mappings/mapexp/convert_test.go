...
func TestConvert(t *testing.T) {
	...
	tests := []struct {
		...
		{types.Int8(), types.Boolean(), 0, false, true, nil},
		{types.Int8(), types.Boolean(), 1, true, true, nil},
		{types.Int8(), types.Boolean(), -1, true, true, nil},
		{types.UInt8(), types.Boolean(), uint(0), false, true, nil},
		{types.UInt8(), types.Boolean(), uint(1), true, true, nil},
		...
		{types.Int(), types.Int(), 831, 831, true, nil},
		{types.Int(), types.Int8(), -123, -123, true, nil},
		{types.Int(), types.Int16(), 2571, 2571, true, nil},
		{types.Int(), types.Int24(), 670329, 670329, true, nil},
		{types.Int(), types.Int64(), math.MaxInt64, math.MaxInt64, true, nil},
		{types.UInt8(), types.Int(), uint(7), 7, true, nil},
		{types.Int16(), types.Int(), -29, -29, true, nil},
		{types.UInt24(), types.Int(), uint(89302), 89302, true, nil},
		{types.Int64(), types.Int(), math.MaxInt32, math.MaxInt32, true, nil},
		{types.Float(), types.Int24(), 10.0, 10, true, nil},
		{types.Float(), types.Int8(), 34.4, 34, true, nil},
		{types.Float(), types.Int8(), 34.5, 35, true, nil},
		{types.Float(), types.Int8(), -0.49, 0, true, nil},
		{types.Float32(), types.Int8(), -0.5, -1, true, nil},
		{types.Float(), types.Int64(), minFloatConvertibleToInt64, -9223372036854775808, true, nil},
		{types.Float(), types.Int64(), maxFloatConvertibleToInt64, 9223372036854774784, true, nil},
		{types.Decimal(5, 3), types.Int(), decimal.RequireFromString("5"), 5, true, nil},
		{types.Decimal(5, 3), types.Int8(), decimal.RequireFromString("-12.0"), -12, true, nil},
		{types.Decimal(60, 0), types.Int64(), minIntDecimal, math.MinInt64, true, nil},
		{types.Decimal(60, 0), types.Int64(), maxIntDecimal, math.MaxInt64, true, nil},
		{types.Year(), types.Int16(), 2020, 2020, true, nil},
		{types.Text(), types.Int(), "502842", 502842, true, nil},
		{types.Text(), types.Int(), "", nil, true, nil},
		{types.JSON(), types.Int(), 12.627, 13, true, nil},
		{types.JSON(), types.Int(), json.Number("-15"), -15, true, nil},
		{types.JSON(), types.Int(), json.RawMessage("-2"), -2, true, nil},
		{types.Boolean(), types.Int8(), false, 0, true, nil},
		{types.Boolean(), types.Int8(), true, 1, true, nil},

		// UInt, UInt8, UInt16, UInt24 and UInt64.
		{types.Int(), types.UInt(), 831, uint(831), true, nil},
		{types.Int(), types.UInt8(), 218, uint(218), true, nil},
		{types.Int(), types.UInt16(), 2571, uint(2571), true, nil},
		{types.Int(), types.UInt24(), 670329, uint(670329), true, nil},
		{types.UInt(), types.UInt64(), uint(math.MaxUint32), uint(math.MaxUint32), true, nil},
		{types.UInt8(), types.UInt(), uint(7), uint(7), true, nil},
		{types.UInt16(), types.UInt(), uint(29), uint(29), true, nil},
		{types.UInt24(), types.UInt(), uint(89302), uint(89302), true, nil},
		{types.Float(), types.UInt64(), maxFloatConvertibleToUInt64, uint(18446744073709549568), true, nil},
		{types.Decimal(60, 0), types.UInt64(), maxUIntDecimal, uint(math.MaxUint64), true, nil},
		{types.Year(), types.UInt16(), 2020, uint(2020), true, nil},
		{types.Text(), types.UInt(), "502842", uint(502842), true, nil},
		{types.JSON(), types.UInt64(), maxFloatConvertibleToUInt64, uint(18446744073709549568), true, nil},
		{types.JSON(), types.UInt(), json.Number("15"), uint(15), true, nil},
		{types.JSON(), types.UInt(), json.RawMessage("2"), uint(2), true, nil},
		{types.Boolean(), types.UInt8(), false, uint(0), true, nil},
		{types.Boolean(), types.UInt8(), true, uint(1), true, nil},

		// Float and Float32.
		{types.Float(), types.Float(), 701.502830285, 701.502830285, true, nil},
		{types.Float(), types.Float32(), 3.918347105316932e+10, float64(float32(3.918347e+10)), true, nil},
		{types.Float32(), types.Float32(), float64(float32(6316.0513)), float64(float32(6316.0513)), true, nil},
		{types.Float32(), types.Float(), float64(float32(-32.04262)), -32.04262161254883, true, nil},
		{types.Int(), types.Float(), 5617072831, 5.617072831e+09, true, nil},
		{types.UInt8(), types.Float32(), uint(256), float64(float32(256)), true, nil},
		{types.Decimal(20, 10), types.Float(), decimal.RequireFromString("767.5018382257"), 767.5018382257, true, nil},
		{types.Text(), types.Float(), "767.5018382257", 767.5018382257, true, nil},
		{types.JSON(), types.Float(), 767.5018382257, 767.5018382257, true, nil},
		{types.JSON(), types.Float(), json.Number("767.5018382257"), 767.5018382257, true, nil},
		{types.JSON(), types.Float(), json.RawMessage("767.5018382257"), 767.5018382257, true, nil},

		// Decimal.
		{types.Int(), types.Decimal(10, 3), math.MaxInt32, decimal.NewFromInt(math.MaxInt32), true, nil},
		{types.Int(), types.Decimal(10, 0), math.MinInt32, decimal.NewFromInt(math.MinInt32), true, nil},
		{types.UInt8(), types.Decimal(3, 0), uint(math.MaxUint8), decimal.NewFromInt(math.MaxUint8), true, nil},
		{types.Float(), types.Decimal(3, 0), 3.918347105316932e+10, decimal.RequireFromString("39183471053.16932"), true, nil},
		{types.Float32(), types.Decimal(3, 0), float64(float32(6316.0513)), decimal.RequireFromString("6316.05126953125"), true, nil},
		...
		{types.DateTime(), types.DateTime(), time.Date(2023, 5, 24, 9, 1, 57, 493614090, time.UTC), int64(1684918917), true, &state.Layouts{DateTime: "unix"}},
		{types.DateTime(), types.DateTime(), time.Date(2023, 5, 24, 9, 1, 57, 493614090, time.UTC), int64(1684918917493), true, &state.Layouts{DateTime: "unixmilli"}},
		{types.DateTime(), types.DateTime(), time.Date(2023, 5, 24, 9, 1, 57, 493614090, time.UTC), int64(1684918917493614), true, &state.Layouts{DateTime: "unixmicro"}},
		{types.DateTime(), types.DateTime(), time.Date(2023, 5, 24, 9, 1, 57, 493614090, time.UTC), int64(1684918917493614090), true, &state.Layouts{DateTime: "unixnano"}},
		{types.DateTime(), types.DateTime(), time.Date(2023, 5, 24, 9, 1, 57, 493614090, time.UTC), "Wednesday, 24-May-23 09:01:57 UTC", true, &state.Layouts{DateTime: time.RFC850}},
		{types.Text(), types.DateTime(), "2023-05-24T09:01:57.49361409Z", "Wed, 24 May 2023 09:01:57 +0000", true, &state.Layouts{DateTime: time.RFC1123Z}},
		{types.DateTime(), types.DateTime(), time.Date(2023, 5, 24, 9, 1, 57, 493614090, time.UTC), time.Date(2023, 5, 24, 9, 1, 57, 493614090, time.UTC), true, nil},
		...
		{types.Date(), types.Date(), time.Date(2023, 5, 24, 0, 0, 0, 0, time.UTC), "2023-05-24", true, &state.Layouts{Date: time.DateOnly}},
		{types.Text(), types.Date(), "2023-05-24", "05/24/2023", true, &state.Layouts{Date: "01/02/2006"}},
		...
		{types.Time(), types.Time(), time.Date(1970, 1, 1, 9, 1, 57, 493614090, time.UTC), "09:01:57.493614", true, &state.Layouts{Time: "15:04:05.999999"}},
		{types.Time(), types.Time(), time.Date(1970, 1, 1, 9, 1, 57, 493614090, time.UTC), time.Date(1970, 1, 1, 9, 1, 57, 493614090, time.UTC), true, nil},

		// Year.
		{types.Year(), types.Year(), 2023, 2023, true, nil},
		{types.Int16(), types.Year(), 1, 1, true, nil},
		{types.UInt64(), types.Year(), uint(9999), 9999, true, nil},
		...
		// JSON.
		{types.Int(), types.JSON(), nil, nil, true, nil},
		{types.Int(), types.JSON(), nil, json.RawMessage(`null`), false, nil},
		...
		// Text.
		{types.Int(), types.Text(), nil, nil, true, nil},
		{types.Int(), types.Text(), nil, "", false, nil},
		...
		{types.Int(), types.Text(), -603, "-603", true, nil},
		{types.Float(), types.Text(), 7928301735.704827, "7.928301735704827e+09", true, nil},
		{types.Float32(), types.Text(), 3.14, "3.14", true, nil},
		...
		// Array.
		{types.Array(types.Int()), types.Array(types.Int()), []any{1, 2, 3}, []any{1, 2, 3}, true, nil},
		{types.Array(types.Int()), types.Array(types.Int8()), []any{1, 2, 3}, []any{1, 2, 3}, true, nil},
		{types.JSON(), types.Array(types.Int()), []any{1.0, 2.0, 3.0}, []any{1, 2, 3}, true, nil},
		{types.JSON(), types.Array(types.Int()), []any{json.Number("1"), json.Number("2"), json.Number("3")}, []any{1, 2, 3}, true, nil},
		{types.JSON(), types.Array(types.Int()), json.RawMessage(`[1,2,3]`), []any{1, 2, 3}, true, nil},
		...
		{types.Map(types.Int16()), types.Map(types.Float32()), map[string]any{"a": 4032, "b": -721}, map[string]any{"a": float64(float32(4032)), "b": float64(float32(-721))}, true, nil},
		{types.JSON(), types.Map(types.Float32()), map[string]any{"a": 4032.0, "b": -721.0}, map[string]any{"a": float64(float32(4032)), "b": float64(float32(-721))}, true, nil},
		{types.JSON(), types.Map(types.Float32()), map[string]any{"a": json.Number("4032"), "b": json.Number("-721")}, map[string]any{"a": float64(float32(4032)), "b": float64(float32(-721))}, true, nil},
		{types.JSON(), types.Map(types.Float32()), json.RawMessage(`{"a":4032,"b":-721}`), map[string]any{"a": float64(float32(4032)), "b": float64(float32(-721))}, true, nil},
	}
