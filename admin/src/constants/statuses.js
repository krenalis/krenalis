...
const statuses = {
	...
	usersNotFound: [variants.DANGER, icons.NOT_FOUND, 'This users does not exist'],
	...
	noWarehouse: [variants.DANGER, icons.FORBIDDEN, 'The workspace is not connected to any data warehouse'],
