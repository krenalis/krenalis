...
const REQUEST_PATTERNS = [
	...
	'/metrics/identities/dates/:start/:end',
	'/metrics/identities/latest',
	'/metrics/identities/refresh',
	'/metrics/identity-resolution/dates/:start/:end',
	'/metrics/identity-resolution/latest',
