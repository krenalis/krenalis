...
import './ConfigurationsSchema.css';
import StatusMessage from '../../../components/StatusMessage/StatusMessage';
import Button from '../../../components/Button/Button';

import { DiffEditor } from '@monaco-editor/react';

export default class ConfigurationsSchema extends Component {
	...
	render() {
		return (
			<div className="ConfigurationsSchema">
				<div className="content">
					...
					<div className="bar">
						...
						<Button theme="primary" text="Save" onClick={this.handleSchemaSaving} icon="save" />
					</div>
