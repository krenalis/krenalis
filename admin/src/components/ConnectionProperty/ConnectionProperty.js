...
const ConnectionProperty = ({ name, label, type, isSelected, onHandle, onRemove, disableRemove, onConnect }) => {
	return (
		<div key={name} className={`ConnectionProperty ${type}${isSelected ? ' selected' : ''}`} id={name}>
