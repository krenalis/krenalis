	...
	render() {
		return (
			<div className="ConnectorRange">
				<SlRange name={this.props.name} value={this.state.value} label={this.props.label} min={this.props.min} max={this.props.max} step={this.props.step} onSlChange={this.onRangeChange} />
			</div>
		)
	}
}
